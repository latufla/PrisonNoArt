...
{
    public class RewardedVideoWatchedTracker : IAdsStateTracker
    {
        private readonly IRewardedVideoService _rewardedVideoService;
        private readonly IAnalyticsService _analyticsService;


        public RewardedVideoWatchedTracker(IRewardedVideoService rewardedVideoService,
        ...
        private void RewardedVideoService_OnRewardedVideoDismissed(RewardedVideoDismissedEventArgs args)
        {
            ...
            _analyticsService.ReportEvent(RewardedVideoWatched, message);
